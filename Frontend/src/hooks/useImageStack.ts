...
const tiler = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/alicatador-azulejos_kaexy4.png"
const heater = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/calefaccion_ixqr4s.png"
const carpenter = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/carpintero-metalico_ugvrk4.png"
const glaziers = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/cristaleros_p5dphn.png"
const elderlyCare = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/elderly-care_zzaax9.png"
const electrician = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/electricista_xopgxu.png"
const cementPlasterer = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/enfoscador-cemento_yswkvm.png"
const ladder = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/escaleras_bwcsb5.png"
const coversRoof = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912278/especialisteencubiertas-tejado_mhlgt7.png"
const plumber = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/fontanero_kap0fh.png"
const homeRepair = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/Home-repair-1_pt4wab.png"
const nanny = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/nanny_nsmp4s.png"
const wallpaper = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/papel-pared_g1ck8s.png"
const painter = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/pintor_g6zjuk.png"
const wallCovering = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/revestimientos-pared_sp1vtn.png"
const floors = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912280/suelo_nva2nz.png"
const washerTechnician = "https://res.cloudinary.com/dptkzrmqc/image/upload/v1681912279/tecnico-electrodomesticos-lavadora_tkoa0o.png"
